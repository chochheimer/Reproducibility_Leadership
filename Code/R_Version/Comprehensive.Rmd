...
**Note this (comprehensive) report will be very similar to the collaborator report, differing only by inclusion of code chunks**
...
# Session Info
```{r Session info}
writeLines(capture.output(sessionInfo()), "comprehensive_session_info.txt")
```
